...
5. 协作过程：
	...
	7. 签发工单：
		...
		2. 经理有权脱离《管理机构设置方案》、《基本管理制度》规定签发《通用工单》，但要对其损失承担无限责任。收到工单者验证无误，必须按规章完成并提交《通用日志》。
...
6. 分配规则：
	...
	5. 在企业收支不平衡时，以上报酬均只记账不发放，按20%计算年息。在收支平衡后，每年末以可分配利润的50%（即与股东分红总额相等）支付这些报酬，金额不足时按比例偿还，直至还清。此前因失职解聘的记账清零，任满离职的照常偿还。
